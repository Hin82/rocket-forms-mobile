...
const styles = StyleSheet.create({
  ...
  requiredIndicator: { flexDirection: 'row', alignItems: 'center', marginRight: 8, gap: 4 },
  requiredDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#e8622c' },
  requiredAsterisk: { color: '#e8622c', fontSize: 16, fontWeight: '700', lineHeight: 16 },
